    ...
    return (
      <div>
        ...
        <div className="relative flex items-center">
          {icon && (
            <div className="absolute left-3 flex items-center justify-center w-4 h-4">
              <Image 
                src={icon} 
                alt="" 
                fill 
...
const SectionHeader: React.FC<{ title: string; titleMarathi: string; icon: string }> = ({ 
  title, 
  titleMarathi, 
  icon 
}) => {
  ...
  const sections: SectionConfig[] = [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          icon: "/hugeicons_save-money-dollar.png",
          readOnly: true,
          required: true,
          textAlign: "right",
        },
