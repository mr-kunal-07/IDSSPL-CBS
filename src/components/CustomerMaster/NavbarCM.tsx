            ...
            {isSearchVisible && (
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex w-[200px] items-center gap-2.5 rounded-lg border border-[#0B63C1] bg-white px-3 py-2 text-left hover:bg-[#F8FBFF] sm:w-[240px] h-10 transition shrink-0"
                >
                      ...
                      <span>
                        {(() => {
                          ...
                          if (filters.customerId)
                            active.push({ label: "ID", value: filters.customerId });
                          if (filters.customerName)
                            active.push({ label: "Name", value: filters.customerName });
                          if (filters.status)
